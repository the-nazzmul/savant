...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-r from-neutral-600 via-neutral-400 to-neutral-600 relative flex flex-col items-center justify-center antialiased py-20">
          ...
          <div className=" flex items-center justify-center gap-2">
            {lastChat && (
              <div className="flex justify-center gap-4 my-2">
                <Link href={lastChat ? `/chat/${lastChat.id}` : "/"}>
